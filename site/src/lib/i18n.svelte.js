...
const tr = {
  ...
  "hero.sub":
    "Discord, Roblox ve oyunları tek tıkla açan Windows aracı. Hızın düşmez — yalnızca engellenen trafiğe dokunur, gerisi doğrudan akar.",
  ...
  "how.warp.d":
    "Discord sesi gibi bazı uygulamalar temiz bir rota ister. evorift yalnızca o uygulamaları Cloudflare WARP üzerinden gönderir; bağlantının geri kalanı doğrudan kalır.",
...
const en = {
  ...
  "hero.sub":
    "A Windows tool that unblocks Discord, Roblox and games in one click. No speed loss — it only touches the traffic that's blocked, everything else stays direct.",
  ...
  "how.warp.d":
    "Some apps — like Discord voice — need a clean route. evorift sends only those apps through Cloudflare WARP, while the rest of your connection stays direct.",
...
const es = {
  ...
  "hero.sub":
    "Una herramienta de Windows que desbloquea Discord, Roblox y juegos con un clic. Sin pérdida de velocidad: solo toca el tráfico bloqueado, el resto va directo.",
  ...
  "how.warp.d":
    "Algunas apps —como la voz de Discord— necesitan una ruta limpia. evorift envía solo esas apps por Cloudflare WARP, mientras el resto de tu conexión va directo.",
...
const ru = {
  ...
  "hero.sub":
    "Программа для Windows, которая разблокирует Discord, Roblox и игры одним кликом. Без потери скорости — затрагивает только заблокированный трафик, остальное идёт напрямую.",
  ...
  "how.warp.d":
    "Некоторым приложениям — например, голосу Discord — нужен чистый маршрут. evorift отправляет через Cloudflare WARP только эти приложения, а остальное соединение идёт напрямую.",
